...
% basemodel1.m
%
% Model exported on Aug 2 2021, 09:50 by COMSOL 5.4.0.295.
...
model.geom('geom1').runPre('fin');
model.geom('geom1').create('blkgb7', 'Block');
model.geom('geom1').feature('blkgb7').set('size', {'wb' 'wb' 'hb'});
model.geom('geom1').feature('blkgb7').set('base', 'corner');
model.geom('geom1').feature('blkgb7').set('pos', [-9.333333333333335E-8 -1.2000000000000002E-7 -1.0E-8]);
model.geom('geom1').runPre('fin');
model.geom('geom1').create('blkgb8', 'Block');
model.geom('geom1').feature('blkgb8').set('size', {'wb' 'wb' 'hb'});
model.geom('geom1').feature('blkgb8').set('base', 'corner');
model.geom('geom1').feature('blkgb8').set('pos', [9.333333333333332E-8 -1.2000000000000002E-7 -1.0E-8]);
model.geom('geom1').runPre('fin');
model.geom('geom1').create('blkgb9', 'Block');
model.geom('geom1').feature('blkgb9').set('size', {'wb' 'wb' 'hb'});
model.geom('geom1').feature('blkgb9').set('base', 'corner');
model.geom('geom1').feature('blkgb9').set('pos', [2.0000000000000004E-7 -1.2000000000000002E-7 -1.0E-8]);
model.geom('geom1').runPre('fin');
model.geom('geom1').create('blkgb10', 'Block');
model.geom('geom1').feature('blkgb10').set('size', {'wb' 'wb' 'hb'});
model.geom('geom1').feature('blkgb10').set('base', 'corner');
model.geom('geom1').feature('blkgb10').set('pos', [-1.7333333333333335E-7 -6.666666666666668E-8 -1.0E-8]);
model.geom('geom1').runPre('fin');
model.geom('geom1').create('blkgb11', 'Block');
model.geom('geom1').feature('blkgb11').set('size', {'wb' 'wb' 'hb'});
model.geom('geom1').feature('blkgb11').set('base', 'corner');
model.geom('geom1').feature('blkgb11').set('pos', [2.0000000000000004E-7 -6.666666666666668E-8 -1.0E-8]);
model.geom('geom1').runPre('fin');
model.geom('geom1').create('blkgb12', 'Block');
model.geom('geom1').feature('blkgb12').set('size', {'wb' 'wb' 'hb'});
model.geom('geom1').feature('blkgb12').set('base', 'corner');
model.geom('geom1').feature('blkgb12').set('pos', [-2.2666666666666668E-7 -3.999999999999999E-8 -1.0E-8]);
model.geom('geom1').runPre('fin');
model.geom('geom1').create('blkgb13', 'Block');
model.geom('geom1').feature('blkgb13').set('size', {'wb' 'wb' 'hb'});
model.geom('geom1').feature('blkgb13').set('base', 'corner');
model.geom('geom1').feature('blkgb13').set('pos', [1.1999999999999996E-7 9.333333333333332E-8 -1.0E-8]);
model.geom('geom1').runPre('fin');
model.geom('geom1').create('blkgb14', 'Block');
model.geom('geom1').feature('blkgb14').set('size', {'wb' 'wb' 'hb'});
model.geom('geom1').feature('blkgb14').set('base', 'corner');
model.geom('geom1').feature('blkgb14').set('pos', [-1.2000000000000002E-7 1.1999999999999996E-7 -1.0E-8]);
model.geom('geom1').runPre('fin');
model.geom('geom1').create('blkgb15', 'Block');
model.geom('geom1').feature('blkgb15').set('size', {'wb' 'wb' 'hb'});
model.geom('geom1').feature('blkgb15').set('base', 'corner');
model.geom('geom1').feature('blkgb15').set('pos', [-6.666666666666668E-8 1.1999999999999996E-7 -1.0E-8]);
model.geom('geom1').runPre('fin');
model.geom('geom1').create('blkgb16', 'Block');
model.geom('geom1').feature('blkgb16').set('size', {'wb' 'wb' 'hb'});
model.geom('geom1').feature('blkgb16').set('base', 'corner');
model.geom('geom1').feature('blkgb16').set('pos', [-6.666666666666668E-8 1.4666666666666666E-7 -1.0E-8]);
model.geom('geom1').runPre('fin');
model.geom('geom1').create('blkgb17', 'Block');
model.geom('geom1').feature('blkgb17').set('size', {'wb' 'wb' 'hb'});
model.geom('geom1').feature('blkgb17').set('base', 'corner');
model.geom('geom1').feature('blkgb17').set('pos', [-2.0000000000000002E-7 2.0000000000000004E-7 -1.0E-8]);
model.geom('geom1').runPre('fin');
model.geom('geom1').create('blkgb18', 'Block');
model.geom('geom1').feature('blkgb18').set('size', {'wb' 'wb' 'hb'});
model.geom('geom1').feature('blkgb18').set('base', 'corner');
model.geom('geom1').feature('blkgb18').set('pos', [-1.4666666666666668E-7 2.0000000000000004E-7 -1.0E-8]);
model.geom('geom1').runPre('fin');
model.geom('geom1').create('blkgb19', 'Block');
model.geom('geom1').feature('blkgb19').set('size', {'wb' 'wb' 'hb'});
model.geom('geom1').feature('blkgb19').set('base', 'corner');
model.geom('geom1').feature('blkgb19').set('pos', [-1.3333333333333347E-8 2.0000000000000004E-7 -1.0E-8]);
model.geom('geom1').runPre('fin');
model.geom('geom1').create('blkgb20', 'Block');
model.geom('geom1').feature('blkgb20').set('size', {'wb' 'wb' 'hb'});
model.geom('geom1').feature('blkgb20').set('base', 'corner');
model.geom('geom1').feature('blkgb20').set('pos', [3.999999999999999E-8 2.0000000000000004E-7 -1.0E-8]);
model.geom('geom1').runPre('fin');
model.geom('geom1').create('blkgb21', 'Block');
model.geom('geom1').feature('blkgb21').set('size', {'wb' 'wb' 'hb'});
model.geom('geom1').feature('blkgb21').set('base', 'corner');
model.geom('geom1').feature('blkgb21').set('pos', [6.666666666666668E-8 2.0000000000000004E-7 -1.0E-8]);
model.geom('geom1').runPre('fin');
model.geom('geom1').create('blkgb22', 'Block');
model.geom('geom1').feature('blkgb22').set('size', {'wb' 'wb' 'hb'});
model.geom('geom1').feature('blkgb22').set('base', 'corner');
model.geom('geom1').feature('blkgb22').set('pos', [1.4666666666666666E-7 2.0000000000000004E-7 -1.0E-8]);
model.geom('geom1').runPre('fin');
model.geom('geom1').create('blkgb23', 'Block');
model.geom('geom1').feature('blkgb23').set('size', {'wb' 'wb' 'hb'});
model.geom('geom1').feature('blkgb23').set('base', 'corner');
model.geom('geom1').feature('blkgb23').set('pos', [-1.2000000000000002E-7 -2.2666666666666668E-7 -1.0E-8]);
model.geom('geom1').runPre('fin');
model.geom('geom1').create('blkgb24', 'Block');
model.geom('geom1').feature('blkgb24').set('size', {'wb' 'wb' 'hb'});
model.geom('geom1').feature('blkgb24').set('base', 'corner');
model.geom('geom1').feature('blkgb24').set('pos', [-3.999999999999999E-8 -2.2666666666666668E-7 -1.0E-8]);
model.geom('geom1').runPre('fin');
model.geom('geom1').create('blkgb25', 'Block');
model.geom('geom1').feature('blkgb25').set('size', {'wb' 'wb' 'hb'});
model.geom('geom1').feature('blkgb25').set('base', 'corner');
model.geom('geom1').feature('blkgb25').set('pos', [1.3333333333333294E-8 -2.2666666666666668E-7 -1.0E-8]);
model.geom('geom1').runPre('fin');
model.geom('geom1').create('blkgb26', 'Block');
model.geom('geom1').feature('blkgb26').set('size', {'wb' 'wb' 'hb'});
model.geom('geom1').feature('blkgb26').set('base', 'corner');
model.geom('geom1').feature('blkgb26').set('pos', [-2.2666666666666668E-7 -2.0000000000000002E-7 -1.0E-8]);
model.geom('geom1').runPre('fin');
model.geom('geom1').create('blkgb27', 'Block');
model.geom('geom1').feature('blkgb27').set('size', {'wb' 'wb' 'hb'});
model.geom('geom1').feature('blkgb27').set('base', 'corner');
model.geom('geom1').feature('blkgb27').set('pos', [3.999999999999999E-8 -1.7333333333333335E-7 -1.0E-8]);
model.geom('geom1').runPre('fin');
model.geom('geom1').create('blkgb28', 'Block');
model.geom('geom1').feature('blkgb28').set('size', {'wb' 'wb' 'hb'});
model.geom('geom1').feature('blkgb28').set('base', 'corner');
model.geom('geom1').feature('blkgb28').set('pos', [2.0000000000000004E-7 -1.7333333333333335E-7 -1.0E-8]);
model.geom('geom1').runPre('fin');
model.geom('geom1').create('blkgb29', 'Block');
model.geom('geom1').feature('blkgb29').set('size', {'wb' 'wb' 'hb'});
model.geom('geom1').feature('blkgb29').set('base', 'corner');
model.geom('geom1').feature('blkgb29').set('pos', [-1.2000000000000002E-7 -1.2000000000000002E-7 -1.0E-8]);
model.geom('geom1').runPre('fin');
model.geom('geom1').create('blkgb30', 'Block');
model.geom('geom1').feature('blkgb30').set('size', {'wb' 'wb' 'hb'});
model.geom('geom1').feature('blkgb30').set('base', 'corner');
model.geom('geom1').feature('blkgb30').set('pos', [6.666666666666668E-8 -1.2000000000000002E-7 -1.0E-8]);
model.geom('geom1').runPre('fin');
model.geom('geom1').create('blkgb31', 'Block');
model.geom('geom1').feature('blkgb31').set('size', {'wb' 'wb' 'hb'});
model.geom('geom1').feature('blkgb31').set('base', 'corner');
model.geom('geom1').feature('blkgb31').set('pos', [2.2666666666666663E-7 -1.2000000000000002E-7 -1.0E-8]);
model.geom('geom1').runPre('fin');
model.geom('geom1').create('blkgb32', 'Block');
model.geom('geom1').feature('blkgb32').set('size', {'wb' 'wb' 'hb'});
model.geom('geom1').feature('blkgb32').set('base', 'corner');
model.geom('geom1').feature('blkgb32').set('pos', [-6.666666666666668E-8 -9.333333333333335E-8 -1.0E-8]);
model.geom('geom1').runPre('fin');
model.geom('geom1').create('blkgb33', 'Block');
model.geom('geom1').feature('blkgb33').set('size', {'wb' 'wb' 'hb'});
model.geom('geom1').feature('blkgb33').set('base', 'corner');
model.geom('geom1').feature('blkgb33').set('pos', [6.666666666666668E-8 -6.666666666666668E-8 -1.0E-8]);
model.geom('geom1').runPre('fin');
model.geom('geom1').create('blkgb34', 'Block');
model.geom('geom1').feature('blkgb34').set('size', {'wb' 'wb' 'hb'});
model.geom('geom1').feature('blkgb34').set('base', 'corner');
model.geom('geom1').feature('blkgb34').set('pos', [9.333333333333332E-8 -6.666666666666668E-8 -1.0E-8]);
model.geom('geom1').runPre('fin');
model.geom('geom1').create('blkgb35', 'Block');
model.geom('geom1').feature('blkgb35').set('size', {'wb' 'wb' 'hb'});
model.geom('geom1').feature('blkgb35').set('base', 'corner');
model.geom('geom1').feature('blkgb35').set('pos', [-2.2666666666666668E-7 3.999999999999999E-8 -1.0E-8]);
model.geom('geom1').runPre('fin');
model.geom('geom1').create('blkgb36', 'Block');
model.geom('geom1').feature('blkgb36').set('size', {'wb' 'wb' 'hb'});
model.geom('geom1').feature('blkgb36').set('base', 'corner');
model.geom('geom1').feature('blkgb36').set('pos', [-6.666666666666668E-8 3.999999999999999E-8 -1.0E-8]);
model.geom('geom1').runPre('fin');
model.geom('geom1').create('blkgb37', 'Block');
model.geom('geom1').feature('blkgb37').set('size', {'wb' 'wb' 'hb'});
model.geom('geom1').feature('blkgb37').set('base', 'corner');
model.geom('geom1').feature('blkgb37').set('pos', [3.999999999999999E-8 3.999999999999999E-8 -1.0E-8]);
model.geom('geom1').runPre('fin');
model.geom('geom1').create('blkgb38', 'Block');
model.geom('geom1').feature('blkgb38').set('size', {'wb' 'wb' 'hb'});
model.geom('geom1').feature('blkgb38').set('base', 'corner');
model.geom('geom1').feature('blkgb38').set('pos', [1.1999999999999996E-7 3.999999999999999E-8 -1.0E-8]);
model.geom('geom1').runPre('fin');
model.geom('geom1').create('blkgb39', 'Block');
model.geom('geom1').feature('blkgb39').set('size', {'wb' 'wb' 'hb'});
model.geom('geom1').feature('blkgb39').set('base', 'corner');
model.geom('geom1').feature('blkgb39').set('pos', [1.7333333333333335E-7 3.999999999999999E-8 -1.0E-8]);
model.geom('geom1').runPre('fin');
model.geom('geom1').create('blkgb40', 'Block');
model.geom('geom1').feature('blkgb40').set('size', {'wb' 'wb' 'hb'});
model.geom('geom1').feature('blkgb40').set('base', 'corner');
model.geom('geom1').feature('blkgb40').set('pos', [-2.2666666666666668E-7 6.666666666666668E-8 -1.0E-8]);
model.geom('geom1').runPre('fin');
model.geom('geom1').create('blkgb41', 'Block');
model.geom('geom1').feature('blkgb41').set('size', {'wb' 'wb' 'hb'});
model.geom('geom1').feature('blkgb41').set('base', 'corner');
model.geom('geom1').feature('blkgb41').set('pos', [-1.2000000000000002E-7 6.666666666666668E-8 -1.0E-8]);
model.geom('geom1').runPre('fin');
model.geom('geom1').create('blkgb42', 'Block');
model.geom('geom1').feature('blkgb42').set('size', {'wb' 'wb' 'hb'});
model.geom('geom1').feature('blkgb42').set('base', 'corner');
model.geom('geom1').feature('blkgb42').set('pos', [6.666666666666668E-8 9.333333333333332E-8 -1.0E-8]);
model.geom('geom1').runPre('fin');
model.geom('geom1').create('blkgb43', 'Block');
model.geom('geom1').feature('blkgb43').set('size', {'wb' 'wb' 'hb'});
model.geom('geom1').feature('blkgb43').set('base', 'corner');
model.geom('geom1').feature('blkgb43').set('pos', [1.4666666666666666E-7 9.333333333333332E-8 -1.0E-8]);
model.geom('geom1').runPre('fin');
model.geom('geom1').create('blkgb44', 'Block');
model.geom('geom1').feature('blkgb44').set('size', {'wb' 'wb' 'hb'});
model.geom('geom1').feature('blkgb44').set('base', 'corner');
model.geom('geom1').feature('blkgb44').set('pos', [-1.2000000000000002E-7 1.4666666666666666E-7 -1.0E-8]);
model.geom('geom1').runPre('fin');
model.geom('geom1').create('blkgb45', 'Block');
model.geom('geom1').feature('blkgb45').set('size', {'wb' 'wb' 'hb'});
model.geom('geom1').feature('blkgb45').set('base', 'corner');
model.geom('geom1').feature('blkgb45').set('pos', [2.0000000000000004E-7 1.4666666666666666E-7 -1.0E-8]);
model.geom('geom1').runPre('fin');
model.geom('geom1').create('blkgb46', 'Block');
model.geom('geom1').feature('blkgb46').set('size', {'wb' 'wb' 'hb'});
model.geom('geom1').feature('blkgb46').set('base', 'corner');
model.geom('geom1').feature('blkgb46').set('pos', [-1.2000000000000002E-7 1.7333333333333335E-7 -1.0E-8]);
model.geom('geom1').runPre('fin');
model.geom('geom1').create('blkgb47', 'Block');
model.geom('geom1').feature('blkgb47').set('size', {'wb' 'wb' 'hb'});
model.geom('geom1').feature('blkgb47').set('base', 'corner');
model.geom('geom1').feature('blkgb47').set('pos', [-1.7333333333333335E-7 2.0000000000000004E-7 -1.0E-8]);
model.geom('geom1').runPre('fin');
model.geom('geom1').create('blkgb48', 'Block');
model.geom('geom1').feature('blkgb48').set('size', {'wb' 'wb' 'hb'});
model.geom('geom1').feature('blkgb48').set('base', 'corner');
model.geom('geom1').feature('blkgb48').set('pos', [-3.999999999999999E-8 2.0000000000000004E-7 -1.0E-8]);
model.geom('geom1').runPre('fin');
model.geom('geom1').create('blkgb49', 'Block');
model.geom('geom1').feature('blkgb49').set('size', {'wb' 'wb' 'hb'});
model.geom('geom1').feature('blkgb49').set('base', 'corner');
model.geom('geom1').feature('blkgb49').set('pos', [1.3333333333333294E-8 2.0000000000000004E-7 -1.0E-8]);
model.geom('geom1').runPre('fin');
model.geom('geom1').create('blkgb50', 'Block');
model.geom('geom1').feature('blkgb50').set('size', {'wb' 'wb' 'hb'});
model.geom('geom1').feature('blkgb50').set('base', 'corner');
model.geom('geom1').feature('blkgb50').set('pos', [-1.4666666666666668E-7 2.2666666666666663E-7 -1.0E-8]);
model.geom('geom1').runPre('fin');
model.geom('geom1').create('blkgb51', 'Block');
model.geom('geom1').feature('blkgb51').set('size', {'wb' 'wb' 'hb'});
model.geom('geom1').feature('blkgb51').set('base', 'corner');
model.geom('geom1').feature('blkgb51').set('pos', [-1.3333333333333347E-8 2.2666666666666663E-7 -1.0E-8]);
model.geom('geom1').runPre('fin');
model.geom('geom1').create('blkgb52', 'Block');
model.geom('geom1').feature('blkgb52').set('size', {'wb' 'wb' 'hb'});
model.geom('geom1').feature('blkgb52').set('base', 'corner');
model.geom('geom1').feature('blkgb52').set('pos', [3.999999999999999E-8 2.2666666666666663E-7 -1.0E-8]);
model.geom('geom1').runPre('fin');
model.geom('geom1').create('blkgb53', 'Block');
model.geom('geom1').feature('blkgb53').set('size', {'wb' 'wb' 'hb'});
model.geom('geom1').feature('blkgb53').set('base', 'corner');
model.geom('geom1').feature('blkgb53').set('pos', [6.666666666666668E-8 2.2666666666666663E-7 -1.0E-8]);
model.geom('geom1').runPre('fin');
model.geom('geom1').create('blkgb54', 'Block');
model.geom('geom1').feature('blkgb54').set('size', {'wb' 'wb' 'hb'});
model.geom('geom1').feature('blkgb54').set('base', 'corner');
model.geom('geom1').feature('blkgb54').set('pos', [1.4666666666666666E-7 2.2666666666666663E-7 -1.0E-8]);
model.geom('geom1').runPre('fin');
model.geom('geom1').create('uni1', 'Union');
model.geom('geom1').feature('uni1').selection('input').set({'blkgb1' 'blkgb2' 'blkgb3' 'blkgb4' 'blkgb5' 'blkgb6' 'blkgb7' 'blkgb8' 'blkgb9' 'blkgb10'  ...
'blkgb11' 'blkgb12' 'blkgb13' 'blkgb14' 'blkgb15' 'blkgb16' 'blkgb17' 'blkgb18' 'blkgb19' 'blkgb20'  ...
'blkgb21' 'blkgb22' 'blkgb23' 'blkgb24' 'blkgb25' 'blkgb26' 'blkgb27' 'blkgb28' 'blkgb29' 'blkgb30'  ...
'blkgb31' 'blkgb32' 'blkgb33' 'blkgb34' 'blkgb35' 'blkgb36' 'blkgb37' 'blkgb38' 'blkgb39' 'blkgb40'  ...
'blkgb41' 'blkgb42' 'blkgb43' 'blkgb44' 'blkgb45' 'blkgb46' 'blkgb47' 'blkgb48' 'blkgb49' 'blkgb50'  ...
'blkgb51' 'blkgb52' 'blkgb53' 'blkgb54'});
...
model.result.export('tbl1').set('filename', 'C:\Users\Alpha\Documents\andy\chiral_models_comsol\r1.txt');
model.result.export.create('tbl2', 'Table');
model.result.export('tbl2').set('table', 'tbl3');
model.result.export('tbl2').set('filename', 'C:\Users\Alpha\Documents\andy\chiral_models_comsol\r2.txt');
...
model.result.export('tbl3').set('filename', 'C:\Users\Alpha\Documents\andy\chiral_models_comsol\r3.txt');
...
model.file.remove('res10');
model.file.remove('res9');
model.file.remove('res15');
model.file.remove('res16');
model.file.remove('res13');
model.file.remove('res14');
model.file.remove('res11');
model.file.remove('res12');
